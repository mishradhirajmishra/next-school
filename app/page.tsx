    ...
    <div className="bg-cream">
      <div className="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
        <div className="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
          ...
          >
            <button className="lg:mx-0 bg-yellow-500 text-white text-xl font-bold rounded-full py-4 px-9 btn-zoom">
              {" "}
              Join for free{" "}
            </button>
        ...
        <div id="girl" className="w-full lg:w-6/12 lg:-mt-10 relative top-6">
          <img
            data-aos="fade-up"
            data-aos-once="true"
            src="img/girl.png"
            className="w-10/12 mx-auto 2xl:-mb-20 aos-init aos-animate "
          />
          <div
            data-aos="fade-up"
            data-aos-delay={300}
    ...
    <div className="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center">
          <img src="img/company/google.svg" className="h-7" />
          <img src="img/company/netflix.svg" className="h-7" />
          <img src="img/company/airbnb.svg" className="h-7" />
          <img
            src="img/company/amazon.svg"
            className="h-7 transform translate-y-2"
          />
          <img src="img/company/facebook.svg" className="h-7" />
          <img src="img/company/grab.svg" className="h-7" />
        </div>
      </div>
      <div
        data-aos="flip-up"
        className="max-w-xl mx-auto text-center mt-24 aos-init"
      >
      ...
      <div className="sm:flex items-center sm:space-x-8 mt-36">
        ...
        >
          ...
          />
          <button className="bg-white w-14 h-14 rounded-full flex items-center justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 btn-zoom z-50">
            <svg
              viewBox="0 0 24 28"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="md:flex mt-40 md:space-x-10 items-start">
        <div data-aos="fade-down" className="md:w-7/12 relative aos-init">
          ...
          />
          <img src="img/vcall.png" alt="" className="relative z-50 floating" />
          <div
      ...
      >
        ...
        <div className="lg:w-7/12 flex flex-col justify-between mt-12 space-y-5 lg:space-y-0 lg:mt-0">
          ...
          <div className="flex space-x-5">
            <div className="w-4/12">
              <div className="relative">
                <img src="img/girl-laptop.png" className="rounded-xl w-full" />
                <span className="absolute bottom-2 right-2 bg-yellow-300 text-darken font-semibold px-4 py-px text-sm rounded-full hidden sm:block">
                  NEWS
                </span>
              </div>
